...
mod kani_harnesses {
    use super::*;
    #[kani::proof]
    fn kani_harness_542_start_address() {
        let callee: MappedFrame = kani::any();
        callee.start_address();
    }

    #[kani::proof]
    fn kani_harness_543_size() {
        let callee: MappedFrame = kani::any();
        callee.size();
    }

    #[kani::proof]
    fn kani_harness_544_new() {
        MapperFlushAll::new();
    }

    #[kani::proof]
    fn kani_harness_545_ignore() {
        let callee: MapperFlushAll = kani::any();
        callee.ignore();
    }
}
