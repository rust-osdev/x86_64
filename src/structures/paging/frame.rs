...
mod kani_harnesses {
    use super::*;
    #[kani::proof]
    fn kani_harness_533_add() {
        let rhs: u64 = kani::any();
        let callee: PhysFrame = kani::any();
        callee.add(rhs);
    }

    #[kani::proof]
    fn kani_harness_534_add_assign() {
        let rhs: u64 = kani::any();
        let mut callee: PhysFrame = kani::any();
        callee.add_assign(rhs);
    }

    #[kani::proof]
    fn kani_harness_535_sub() {
        let rhs: u64 = kani::any();
        let callee: PhysFrame = kani::any();
        callee.sub(rhs);
    }
    ...
    #[kani::proof]
    fn kani_harness_536_sub_assign() {
        let rhs: u64 = kani::any();
        let mut callee: PhysFrame = kani::any();
    ...
    /*
    #[kani::proof]
    fn kani_harness_537_sub() {
        let rhs: PhysFrame<S/#0> = kani::any();
        let callee: PhysFrame = kani::any();
        callee.sub(rhs);
    }
    ...
    */
    #[kani::proof]
    fn kani_harness_538_next() {
        let mut callee: PhysFrameRange = kani::any();
        callee.next();
    }

    #[kani::proof]
    fn kani_harness_539_next() {
        let mut callee: PhysFrameRangeInclusive = kani::any();
        callee.next();
    }
}
