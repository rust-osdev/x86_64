...
mod kani_harnesses {
    use super::*;
    #[kani::proof]
    fn kani_harness_429_new() {
        let raw: u64 = kani::any();
        Entry::new(raw);
    }

    #[kani::proof]
    fn kani_harness_430_raw() {
        let callee: Entry = kani::any();
        callee.raw();
    }

    #[kani::proof]
    fn kani_harness_431_clone() {
        let callee: Entry = kani::any();
        callee.clone();
    }

    #[kani::proof]
    fn kani_harness_432_eq() {
        let other: Entry = kani::any();
        let callee: Entry = kani::any();
        callee.eq(&other);
    }

    #[kani::proof]
    fn kani_harness_433_new() {
        GlobalDescriptorTable::new();
    }

    #[kani::proof]
    fn kani_harness_434_default() {
        GlobalDescriptorTable::default();
    }


    #[kani::proof]
    fn kani_harness_472_dpl() {
        let callee: Descriptor = kani::any();
        callee.dpl();
    }

    #[kani::proof]
    fn kani_harness_473_kernel_code_segment() {
        Descriptor::kernel_code_segment();
    }

    #[kani::proof]
    fn kani_harness_474_kernel_data_segment() {
        Descriptor::kernel_data_segment();
    }

    #[kani::proof]
    fn kani_harness_475_user_data_segment() {
        Descriptor::user_data_segment();
    }

    #[kani::proof]
    fn kani_harness_476_user_code_segment() {
